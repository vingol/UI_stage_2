...
# Form implementation generated from reading ui file '风过程波动预警的置信度.ui'
#
...
class Ui_MainWindow_Wind_Confidence(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(110, 40, 291, 31))
        font = QtGui.QFont()
        ...
        # 画布
        self.m2 = PlotCanvas(self, width=4, height=2)  # 实例化一个画布对象
        self.m2.move(80, 330)

        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(570, 370, 131, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(560, 450, 161, 51))
        self.textBrowser.setObjectName("textBrowser")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(570, 210, 151, 26))
        self.comboBox.setObjectName("comboBox")
        self.dateTimeEdit = QtWidgets.QDateTimeEdit(self.centralwidget)
        self.dateTimeEdit.setGeometry(QtCore.QRect(570, 150, 151, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "风过程波动预警的置信度"))
